...
VALUES (1,'Maria Jesus','Cañoles Roa', '20.300.159-2', '2000/02/23', '2021/12/20', 1, 2),
(2,'Esteban','Gómez', '19.347.109-K', '1999/12/23', '1999/06/24', 3, 1),
(3, 'Denisse', 'González', '18.768.688-1', '1980/11/28', '1979/12/23', 2, 1),
(4, 'Denisse', 'González', '18.768.688-1', '1980/11/28', '1979/12/23', 2, 1),
(5, 'Denisse', 'González', '11.234.123-6', '1980/11/28', '1979/12/23', 3, 2),
(6, 'Denisse', 'González', '12.457.562-3', '1980/11/28', '1979/12/23', 1, 2),
(7, 'Denisse', 'González', '21.142.354-k', '1980/11/28', '1979/12/23', 3, 1),
(8, 'Denisse', 'González', '17.765.876-2', '1980/11/28', '1979/12/23', 2, 1),
(9, 'Denisse', 'González', '12.457.562-3', '1980/11/28', '1979/12/23', 3, 2),
(10, 'Denisse', 'González', '21.142.354-k', '1980/11/28', '1979/12/23', 1, 1),
(11, 'Denisse', 'González', '17.765.876-2', '1980/11/28', '1979/12/23', 2, 2);
